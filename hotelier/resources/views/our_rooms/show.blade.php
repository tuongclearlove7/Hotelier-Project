                    ...
                    <div class="col-md-12 wow fadeInUp" data-wow-delay="0.6s">
                            <div class="room-item shadow rounded overflow-hidden">
                                ...
                                <h3 class="mb-0 text-type-room">
                                    <a href="{{route('hotels.index')}}/hotel_detail/{{$roomType->hotel->id}}">
                                        <i class="fa fa-hotel text-primary me-2"></i>{{"Khách sạn ".$roomType->hotel->name}}
                                    </a>
                                </h3>
                                <br>
                                <div class="py-2 py-img">
                                    <img class="mb-0 text-type-room" src="{{asset('customer/img/'. $roomType->image)}}" alt="" width="60%" srcset="">
                                </div>
                                ...
                                <div class="p-4 mt-2">
                                    ...
                                    <div class="d-flex mb-3">
                                        ...
                                        <small><i class="fa fa-home text-primary me-2"></i>{{$room->quantity}} Phòng</small>
                                    </div>
                                    <div class="d-flex mb-3">
                                        <small class="border-end me-3 pe-3"><i class="fa fa-map text-primary me-2"></i>{{"Địa chỉ ".$roomType->hotel->address}}</small>
                                        <small class="border-end me-3 pe-3"><i class="fa fa-city text-primary me-2"></i>{{"Thành phố ". $roomType->city->name}}</small>
                                    </div>
