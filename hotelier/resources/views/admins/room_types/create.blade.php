...
<div class="row mb-2">
    ...
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Thêm mới kiểu phòng</li>
        </ol>
    </div><!-- /.col -->
</div><!-- /.row -->
@endsection
...
<div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">Thêm mới kiểu phòng</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <form action="{{ route('admin.room_types.store') }}" method="POST">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" name='name' class="form-control" id="name" placeholder="Nhập tên kiểu phòng">
                @error('name')
            ...
            <div class="form-group">
                ...
                <input type="text" name='image' class="form-control" id="image" placeholder="Nhập ảnh">
                @error('image')
                    <div class="text-danger">{{$message}}</div>
                @enderror
            </div>
