...
<div class="row mb-2">
    ...
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Thêm mới loại dịch vụ</li>
        </ol>
    </div><!-- /.col -->
</div><!-- /.row -->
@endsection
    ...
    <form action="{{ route('admin.service_types.store') }}" method="POST">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" name='name' class="form-control" id="name" placeholder="Nhập tên loại dịch vụ">
                @error('name')
            ...
            <div class="form-group">
                ...
                <input type="text" name='description' class="form-control" id="description" placeholder="Nhập mô tả loại dịch vụ">
                @error('description')
                    <div class="text-danger">{{$message}}</div>
                @enderror
            </div>
